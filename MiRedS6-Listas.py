...
#La lista de amigos reemplazarÃ¡ a nuestro antiguo valor "num_amigos". Al conocer la lista de amigos,
...
while opcion != 0:
    ...
    if opcion == 1:
        ...
        nuevo_amigo = input("Ingresa el nombre del amigo a agregar en tu lista ")
        amigos.append(nuevo_amigo)
    elif opcion == 6:
        for amigo in amigos:
            (nombre, edad, estatura_m, estatura_cm, sexo, pais, amigos, estado, muro) = Red.leer_usuario(amigo)
            print("El estado de ", amigo, " es ", estado)
    elif opcion == 0:
